...
public class CompletableFuturePerformance {
    ...
    private static long testStream(int jobCount) {
        ...
        IntStream.rangeClosed(1, jobCount).forEach(value -> tasks.add(CompletableFuturePerformance::getJob));
    ...
    private static long testCompletableFutureDefaultExecutor(int jobCount) {
        ...
        IntStream.rangeClosed(1, jobCount).forEach(value -> tasks.add(CompletableFuture.supplyAsync(CompletableFuturePerformance::getJob)));
    ...
    private static long testCompletableFutureCustomExecutor(int jobCount) {
        ...
        List<CompletableFuture<Integer>> tasks = new ArrayList<>();
        IntStream.rangeClosed(1, jobCount).forEach(value -> tasks.add(CompletableFuture.supplyAsync(CompletableFuturePerformance::getJob, executor)));
